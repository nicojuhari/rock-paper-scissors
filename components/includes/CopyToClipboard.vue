<template>
    <button @click.prevent="copyToClipboard" class="btn relative overflow-hidden justify-center gap-4" :disabled="buttonState !== 'normal'">
        <span v-if="buttonState === 'normal'">Copy Link</span>
