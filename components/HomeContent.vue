<template>
    <div class="space-y-4 mb-14 mt-36">
        <h3 class="text-xl font-medium mb-3 text-center">How to play</h3>
        <ul class="list-disc list-inside space-y-1.5">
            ...
            <li><strong>Play:</strong> Once everyone has joined, you can start playing! Each player will choose Rock,
                ...
                <ul class="pl-6 list-decimal list-inside space-y-1 font-semibold">
        ...
        <div class="text-xl font-medium mb-3 text-center">Have fun!</div>
        <div class="py-10"><strong>P.S.</strong>You can read our <nuxt-link to="/privacy" title="privacy poilicy"
